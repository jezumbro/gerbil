function [BW,maskedRGBImage] = createMask_HP4310_DP9k7(RGB)
...
shiftVec = [-0.086848 -0.011530 0.705963];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-0.901240 -2.293465 -0.000000 0.694274;
    -0.081025 0.450903 0.701842 -0.513390;
    0.604034 -3.361446 0.094145 5.397705;
...
hPoints(1).data = [0.606324 -0.249560;
    0.971451 -0.940123;
    1.387216 -0.660356;
    1.046075 -0.288514];
